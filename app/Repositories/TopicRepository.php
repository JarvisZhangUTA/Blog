...
class TopicRepository
{
    ...
    function findByIdWithComments($id){
    ...
    function findByKeyword($keyword) {
        ...
        foreach ($topics as $topic) {
            $topic->brief = $this->blogSummary($topic->body, 200);
        }

        return $topics;
    }

    function getTopicsFeed(){
        $topics = Topic::latest('created_at')->with('user')->get();
    ...
    function blogSummary( $body, $size, $format = null )
    {
